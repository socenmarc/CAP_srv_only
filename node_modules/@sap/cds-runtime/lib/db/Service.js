...
// REVISIT: rm once always there
require('../common/utils/flavor')()
...
module.exports = class DatabaseService extends cds.Service {
  constructor (...args) {
    ...
    // REVISIT: ensures tenant-aware this.model if this is a transaction
    this._ensureModel = function (req) {
      if (this._is_tx) this.model = (req.context && req.context._model) || req._model
    }
