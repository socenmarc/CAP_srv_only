...
class ResponseContentNegotiator {
   ...
   */
  negotiateContentType (formatManager, representationKind, accept) /* NOSONAR */ {
    ...
    if (!formatDescription) {
      this._logger.warning(
        `No matching content type found for representation kind '${representationKind}'` + ` and accept '${accept}'`
      )
