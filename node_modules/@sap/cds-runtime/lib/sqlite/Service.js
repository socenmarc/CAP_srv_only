...
const _loadSqlite = () => {
  ...
  try {
    ...
    // use sqlite3 injected by caller, e.g. cds deploy
    if (cds.sqlite3) _sqlite = cds.sqlite3
    else throw e
  }
  return _sqlite
}
...
const convertOrderBy = require('./convertOrderBy')
...
module.exports = class SQLiteDatabase extends DatabaseService {
  ...
  init () {
    ...
    this.before('READ', '*', convertOrderBy)
