...
exports.GetAllRequestBuilder = exports.GetAllRequestBuilderV2 = void 0;
var util_1 = require("@sap-cloud-sdk/util");
var common_1 = require("../../common");
var odata_get_all_request_config_1 = require("../../common/request/odata-get-all-request-config");
var entity_deserializer_1 = require("../entity-deserializer");
var uri_conversion_1 = require("../uri-conversion");
var get_all_request_builder_base_1 = require("../../common/request-builder/get-all-request-builder-base");
 ...
 */
var GetAllRequestBuilderV2 = /** @class */ (function (_super) {
    __extends(GetAllRequestBuilderV2, _super);
    /**
     * Creates an instance of GetAllRequestBuilder.
     *
     * @param entityConstructor - Constructor of the entity to create the request for
     */
    function GetAllRequestBuilderV2(entityConstructor) {
        return _super.call(this, entityConstructor, new odata_get_all_request_config_1.ODataGetAllRequestConfig(entityConstructor, uri_conversion_1.oDataUriV2)) || this;
    }
    GetAllRequestBuilderV2.prototype.filter = function (first) {
        var rest = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            rest[_i - 1] = arguments[_i];
        }
        this.requestConfig.filter = common_1.and(util_1.variadicArgumentToArray(first, rest));
        return this;
    };
    /**
     * Execute request.
     ...
     */
    GetAllRequestBuilderV2.prototype.execute = function (destination, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.build(destination, options)
                        ...
                        return response_data_accessor_1.getCollectionResult(response.data).map(function (json) {
                            return entity_deserializer_1.deserializeEntityV2(json, _this._entityConstructor, response.headers);
                        });
                    })];
            });
        });
    };
    return GetAllRequestBuilderV2;
}(get_all_request_builder_base_1.GetAllRequestBuilderBase));
exports.GetAllRequestBuilderV2 = GetAllRequestBuilderV2;
exports.GetAllRequestBuilder = GetAllRequestBuilderV2;
