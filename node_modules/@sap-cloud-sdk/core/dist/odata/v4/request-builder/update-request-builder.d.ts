 ...
 */
export declare class UpdateRequestBuilderV4<EntityT extends EntityV4> extends MethodRequestBuilderBase<ODataUpdateRequestConfig<EntityT>> implements EntityIdentifiable<EntityT> {
