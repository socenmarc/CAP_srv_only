 ...
 */
export declare class BinaryFieldBase<EntityT extends EntityBase> extends EdmTypeField<EntityT, string> {
}
/**
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export declare class BinaryField<EntityT extends EntityBase> extends BinaryFieldBase<EntityT> implements SelectableEdmTypeField {
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export declare class ComplexTypeBinaryPropertyField<EntityT extends EntityBase, ComplexT = any> extends BinaryFieldBase<EntityT> {
    /**
