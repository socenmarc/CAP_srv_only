 ...
 */
export declare class NumberFieldBase<EntityT extends EntityBase> extends EdmTypeField<EntityT, number> {
    /**
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export declare class NumberField<EntityT extends EntityBase> extends NumberFieldBase<EntityT> implements SelectableEdmTypeField {
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export declare class ComplexTypeNumberPropertyField<EntityT extends EntityBase, ComplexT = any> extends NumberFieldBase<EntityT> {
    /**
