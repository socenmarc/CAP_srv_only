 ...
 */
export declare class TimeFieldBase<EntityT extends EntityBase> extends EdmTypeField<EntityT, Time> {
    /**
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export declare class TimeField<EntityT extends EntityBase> extends TimeFieldBase<EntityT> {
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export declare class ComplexTypeTimePropertyField<EntityT extends EntityBase, ComplexT = any> extends TimeFieldBase<EntityT> {
    /**
