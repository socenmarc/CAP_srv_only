 ...
 */
declare class StringFieldBase<EntityT extends EntityBase> extends EdmTypeField<EntityT, string> {
}
/**
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export declare class StringField<EntityT extends EntityBase> extends StringFieldBase<EntityT> implements SelectableEdmTypeField {
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export declare class ComplexTypeStringPropertyField<EntityT extends EntityBase, ComplexT = any> extends StringFieldBase<EntityT> {
    /**
