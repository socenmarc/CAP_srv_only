 ...
 */
export declare class BooleanFieldBase<EntityT extends EntityBase> extends EdmTypeField<EntityT, boolean> {
}
/**
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export declare class BooleanField<EntityT extends EntityBase> extends BooleanFieldBase<EntityT> implements SelectableEdmTypeField {
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export declare class ComplexTypeBooleanPropertyField<EntityT extends EntityBase, ComplexT = any> extends BooleanFieldBase<EntityT> {
    /**
