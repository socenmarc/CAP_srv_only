 ...
 */
export declare class DurtionFieldBase<EntityT extends EntityBase> extends EdmTypeField<EntityT, moment.Duration> {
    /**
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export declare class DurationField<EntityT extends EntityBase> extends DurtionFieldBase<EntityT> {
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export declare class ComplexTypeDurationPropertyField<EntityT extends EntityBase, ComplexT = any> extends DurtionFieldBase<EntityT> {
    /**
