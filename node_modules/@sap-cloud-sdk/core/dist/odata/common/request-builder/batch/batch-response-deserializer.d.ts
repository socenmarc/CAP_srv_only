...
export declare class BatchResponseDeserializer {
     ...
     */
    constructor(entityToConstructorMap: Record<string, Constructable<EntityBase>>, responseDataAccessor: ResponseDataAccessor, deserializer: EntityDeserializer);
    /**
 ...
 * @returns An array of parsed sub responses of the batch response.
 */
export declare function deserializeBatchResponse(parsedBatchResponse: (ResponseData[] | ResponseData)[], entityToConstructorMap: Record<string, Constructable<EntityBase>>, responseDataAccessor: ResponseDataAccessor, deserializer: EntityDeserializer): (ErrorResponse | ReadResponse | WriteResponses)[];
/**
