...
var EntityBase = /** @class */ (function () {
    function EntityBase() {
        util_2.nonEnumerable(this, '_oDataVersion');
        util_2.nonEnumerable(this, '_customFields');
        this._customFields = {};
    }
    EntityBase.entityBuilder = function (entityConstructor) {
        ...
        entityConstructor._allFields.forEach(function (field) {
            var fieldName = "" + util_2.toPropertyFormat(field._fieldName);
    ...
    EntityBase.prototype.setVersionIdentifier = function (etag) {
        if (etag && typeof etag === 'string') {
            util_2.nonEnumerable(this, '_versionIdentifier');
    ...
    EntityBase.prototype.setOrInitializeRemoteState = function (state) {
        var _this = this;
        if (!this.remoteState) {
            util_2.nonEnumerable(this, 'remoteState');
            this.remoteState = {};
        }
        if (state) {
            Object.entries(state).forEach(function (_a) {
                var fieldName = _a[0], value = _a[1];
                if (_this[util_2.toPropertyFormat(fieldName)]) {
                    _this.remoteState[util_2.toPropertyFormat(fieldName)] = value;
                }
                else {
    ...
    EntityBase.prototype.getCurrentMapKeys = function (visitedEntities) {
        ...
        return Object.keys(this)
            .filter(function (key) { return _this.propertyIsEnumerable(key); })
            .filter(function (key) {
            return !util_2.isNavigationProperty(key, _this.constructor) ||
    ...
    EntityBase.prototype.getCurrentStateForKey = function (key, visitedEntities) {
        if (visitedEntities === void 0) { visitedEntities = []; }
        if (util_2.isNavigationProperty(key, this.constructor)) {
    ...
    EntityBase.prototype.isConflictingCustomField = function (customFieldName) {
        return this[util_2.toPropertyFormat(customFieldName)] !== undefined;
    };
    return EntityBase;
}());
