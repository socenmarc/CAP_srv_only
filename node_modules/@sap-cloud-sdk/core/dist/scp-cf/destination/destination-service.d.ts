 ...
 */
export declare function fetchDestination(destinationServiceUri: string, jwt: string, destinationName: string, options?: ResilienceOptions & CachingOptions): Promise<Destination>;
