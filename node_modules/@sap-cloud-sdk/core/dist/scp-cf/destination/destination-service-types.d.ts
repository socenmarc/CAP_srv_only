...
export declare type DestinationProxyType = 'OnPremise' | 'Internet' | null;
/**
...
export declare type AuthenticationType = 'PrincipalPropagation' | 'NoAuthentication' | 'BasicAuthentication' | 'OAuth2SAMLBearerAssertion' | 'OAuth2ClientCredentials' | 'ClientCertificateAuthentication';
/**
