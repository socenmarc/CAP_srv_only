...
function buildHeadersForDestination(destination, customHeaders) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, authorization_header_1.getAuthHeaders(destination, customHeaders)];
                case 1:
                    authHeaders = _a.sent();
                    sapHeaders = header_util_1.replaceDuplicateKeys(header_util_1.filterNullishValues({
                        'sap-client': destination.sapClient,
                        'SAP-Connectivity-SCC-Location_ID': destination.cloudConnectorLocationId
                    }), customHeaders);
                    return [2 /*return*/, __assign(__assign({}, authHeaders), sapHeaders)];
            }
        });
    });
}
