...
function getHeaders(keys, headers) {
    if (headers === void 0) { headers = {}; }
    return keys.reduce(function (filteredHeaders, key) { return (__assign(__assign({}, filteredHeaders), getHeader(key, headers))); }, {});
}
...
function mergeHeaders(headers, customHeaders) {
    if (headers === void 0) { headers = {}; }
    if (customHeaders === void 0) { customHeaders = {}; }
    return __assign(__assign({}, replaceDuplicateKeys(headers, customHeaders)), customHeaders);
}
