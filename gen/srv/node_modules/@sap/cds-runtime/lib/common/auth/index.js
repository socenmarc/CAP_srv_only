...
const _callback = (req, res, next, err, user, info) => {
  ...
  req.user = user || Object.assign(new cds.User(), { _challenges: challenges })

  next()
}

module.exports = (srv, app, auditLogger, options) => {
  if (!options) [auditLogger, options] = [0, auditLogger]
