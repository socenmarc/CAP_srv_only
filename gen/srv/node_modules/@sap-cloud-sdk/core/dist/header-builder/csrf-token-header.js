...
var header_util_1 = require("./header-util");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, header_util_1.filterNullishValues(__assign(__assign({}, header_util_1.getHeader('x-csrf-token', csrfHeaders)), { cookie: buildCookieHeaderValue(header_util_1.getHeaderValue('set-cookie', csrfHeaders)) }))];
            }
        });
    });
}
...
function makeCsrfRequest(destination, requestConfig) {
    var fetchHeader = !header_util_1.getHeaderValue('x-csrf-token', requestConfig.headers) && { 'x-csrf-token': 'Fetch' };
    ...
    return http_client_1.executeHttpRequest(destination, axiosConfig)
        ...
        if (!error.response) {
            ...
            throw util_1.errorWithCause('Csrf fetch failed.', error);
        }
