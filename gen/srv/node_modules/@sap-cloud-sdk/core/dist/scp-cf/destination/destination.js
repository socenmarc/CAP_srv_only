...
function setOriginalProperties(destination) {
    var originalProperties = destination.originalProperties
        ...
        : destination;
    return util_1.assoc('originalProperties', originalProperties, destination);
}
function setDefaultAuthenticationFallback(destination) {
    return destination.authentication
        ? destination
        : util_1.assoc('authentication', getAuthenticationType(destination), destination);
}
...
function parseCertificates(destination) {
    var certificates = destination.certificates
        ...
        : [];
    return util_1.assoc('certificates', certificates, destination);
}
...
function parseAuthTokens(destination) {
    var authTokens = destination.authTokens
        ...
        : [];
    return util_1.assoc('authTokens', authTokens, destination);
}
function setTrustAll(destination) {
    return util_1.assoc('isTrustingAllCertificates', parseTrustAll(destination.isTrustingAllCertificates), destination);
}
