 ...
 */
export declare class CreateRequestBuilderV4<EntityT extends EntityV4> extends MethodRequestBuilderBase<ODataCreateRequestConfig<EntityT>> implements EntityIdentifiable<EntityT> {
     ...
     */
    asChildOf<ParentEntityT extends EntityV4>(parentEntity: ParentEntityT, linkField: Link<ParentEntityT, EntityT>): this;
    /**
     * Execute query.
     *
