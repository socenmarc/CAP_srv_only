...
var UpdateRequestBuilderV4 = /** @class */ (function (_super) {
    ...
    function UpdateRequestBuilderV4(_entityConstructor, _entity) {
        var _this = _super.call(this, new odata_update_request_config_1.ODataUpdateRequestConfig(_entityConstructor, uri_conversion_1.oDataUriV4)) || this;
        ...
        _this.requestConfig.keys = uri_conversion_1.oDataUriV4.getEntityKeys(_this._entity, _this._entityConstructor);
        _this.requestConfig.payload = _this.getPayload();
        return _this;
    }
    Object.defineProperty(UpdateRequestBuilderV4.prototype, "entity", {
        get: function () {
            return this._entity;
        },
        enumerable: false,
     ...
     */
    UpdateRequestBuilderV4.prototype.prepare = function () {
        this.requestConfig.keys = uri_conversion_1.oDataUriV4.getEntityKeys(this._entity, this._entityConstructor);
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, (this.build(destination, options)
                        ...
                        var eTag = entity_deserializer_1.extractEtagFromHeader(response.headers) ||
                            extract_odata_etag_1.extractODataEtagV4(response.data) ||
                            _this.requestConfig.eTag;
                        return _this._entity
                            .setOrInitializeRemoteState()
                            .setVersionIdentifier(_this.requestConfig.eTag);
                    })
     ...
     */
    UpdateRequestBuilderV4.prototype.replaceWholeEntityWithPut = function () {
        this.requestConfig.updateWithPut();
        this.requestConfig.payload = this.getPayload();
        return this;
    };
    UpdateRequestBuilderV4.prototype.requiredFields = function (first) {
        var rest = [];
    ...
    UpdateRequestBuilderV4.prototype.ignoredFields = function (first) {
        var rest = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            rest[_i - 1] = arguments[_i];
        }
     ...
     */
    UpdateRequestBuilderV4.prototype.ignoreVersionIdentifier = function () {
     ...
     */
    UpdateRequestBuilderV4.prototype.withCustomVersionIdentifier = function (etag) {
        this.requestConfig.eTag = etag;
        return this;
    };
    UpdateRequestBuilderV4.prototype.getPayload = function () {
        var serializedBody = entity_serializer_1.serializeEntityV4(this._entity, this._entityConstructor);
    ...
    UpdateRequestBuilderV4.prototype.serializedDiff = function () {
        return __assign(__assign({}, entity_serializer_1.serializeEntityNonCustomFieldsV4(this._entity.getUpdatedProperties(), this._entityConstructor)), this._entity.getUpdatedCustomFields());
    };
    UpdateRequestBuilderV4.prototype.removeKeyFields = function (body) {
        var _this = this;
    ...
    UpdateRequestBuilderV4.prototype.removeIgnoredFields = function (body) {
        var _this = this;
        return removePropertyOnCondition(function (_a) {
            var key = _a[0], val = _a[1];
    ...
    UpdateRequestBuilderV4.prototype.addRequiredFields = function (completeBody, body) {
    ...
    UpdateRequestBuilderV4.prototype.getKeyFieldNames = function () {
        return Object.keys(this._entityConstructor._keys);
    };
    UpdateRequestBuilderV4.prototype.toSet = function (fields) {
        var set = new Set();
    ...
    UpdateRequestBuilderV4.prototype.isEmptyObject = function (obj) {
        for (var key in obj) {
