 ...
 */
declare class AnyFieldBase<EntityT extends EntityBase> extends EdmTypeField<EntityT, any> {
}
/**
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export declare class AnyField<EntityT extends EntityBase> extends AnyFieldBase<EntityT> implements SelectableEdmTypeField {
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export declare class ComplexTypeAnyPropertyField<EntityT extends EntityBase, ComplexT = any> extends AnyFieldBase<EntityT> {
    /**
