 ...
 */
export declare class CollectionFilterFunction<EntityT extends EntityBase, FieldT extends FieldType> extends FilterFunction<EntityT, FieldT[]> {
    /**
...
//# sourceMappingURL=collection-filter-function.d.ts.map