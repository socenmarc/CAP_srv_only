 ...
 */
export declare abstract class FilterFunction<EntityT extends EntityBase, ReturnT extends FieldType | FieldType[]> {
 ...
 */
export declare type FilterFunctionParameterType<EntityT extends EntityBase> = FilterFunctionPrimitiveParameterType | Field<EntityT> | FilterFunction<EntityT, FieldType | FieldType[]> | FilterFunctionPrimitiveParameterType[];
