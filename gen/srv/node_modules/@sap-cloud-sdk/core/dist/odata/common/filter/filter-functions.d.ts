 ...
 */
export declare function endsWith<EntityT extends EntityBase>(str: string | Field<EntityT> | StringFilterFunction<EntityT>, suffix: string | Field<EntityT> | StringFilterFunction<EntityT>): BooleanFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function startsWith<EntityT extends EntityBase>(str: string | Field<EntityT> | StringFilterFunction<EntityT>, prefix: string | Field<EntityT> | StringFilterFunction<EntityT>): BooleanFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function length<EntityT extends EntityBase>(str: string | Field<EntityT> | StringFilterFunction<EntityT>): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function indexOf<EntityT extends EntityBase>(str: string | Field<EntityT> | StringFilterFunction<EntityT>, substr: string | Field<EntityT> | StringFilterFunction<EntityT>): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function substring<EntityT extends EntityBase>(str: string | Field<EntityT> | StringFilterFunction<EntityT>, pos: number | Field<EntityT> | NumberFilterFunction<EntityT>, len?: number | Field<EntityT> | NumberFilterFunction<EntityT>): StringFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function toLower<EntityT extends EntityBase>(str: string | Field<EntityT> | StringFilterFunction<EntityT>): StringFilterFunction<EntityT>;
/**
 * Build a filter function to transform a string to upper case. Evaluates to string.
 * @param str - The string to transform. This can either be a string, a reference to a field or another filter function.
 * @returns The newly created filter function
 */
export declare function toUpper<EntityT extends EntityBase>(str: string | Field<EntityT> | StringFilterFunction<EntityT>): StringFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function trim<EntityT extends EntityBase>(str: string | Field<EntityT> | StringFilterFunction<EntityT>): StringFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function concat<EntityT extends EntityBase>(str1: string | Field<EntityT> | StringFilterFunction<EntityT>, str2: string | Field<EntityT> | StringFilterFunction<EntityT>): StringFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function round<EntityT extends EntityBase>(num: number | Field<EntityT> | NumberFilterFunction<EntityT>, returnType?: 'double' | 'decimal'): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function floor<EntityT extends EntityBase>(num: number | Field<EntityT> | NumberFilterFunction<EntityT>, returnType?: 'double' | 'decimal'): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function ceiling<EntityT extends EntityBase>(num: number | Field<EntityT> | NumberFilterFunction<EntityT>, returnType?: 'double' | 'decimal'): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function day<EntityT extends EntityBase>(date: moment.Moment | Field<EntityT>): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function hour<EntityT extends EntityBase>(date: moment.Moment | Field<EntityT>): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function minute<EntityT extends EntityBase>(date: moment.Moment | Field<EntityT>): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function month<EntityT extends EntityBase>(date: moment.Moment | Field<EntityT>): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function second<EntityT extends EntityBase>(date: moment.Moment | Field<EntityT>): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function year<EntityT extends EntityBase>(date: moment.Moment | Field<EntityT>): NumberFilterFunction<EntityT>;
/**
 ...
 * @returns The newly created filter function
 */
export declare function isOf<EntityT extends EntityBase>(expression: Field<EntityT>, type: string): BooleanFilterFunction<EntityT>;
/**
