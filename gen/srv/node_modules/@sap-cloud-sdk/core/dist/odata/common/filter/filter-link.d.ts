 ...
 */
export declare class FilterLink<EntityT extends EntityBase, LinkedEntityT extends EntityBase = any> implements EntityIdentifiable<EntityT> {
...
export declare function isFilterLink<EntityT extends EntityBase, LinkedT extends EntityBase>(filterable: Filterable<EntityT>): filterable is FilterLink<EntityT, LinkedT>;
