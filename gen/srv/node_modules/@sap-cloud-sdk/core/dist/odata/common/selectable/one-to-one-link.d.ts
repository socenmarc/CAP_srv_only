 ...
 */
export declare class OneToOneLink<EntityT extends EntityBase, LinkedEntityT extends EntityBase> extends Link<EntityT, LinkedEntityT> {
    /**
     ...
     */
    static clone<EntityT1 extends EntityBase, LinkedEntityT1 extends EntityBase>(link: OneToOneLink<EntityT1, LinkedEntityT1>): OneToOneLink<EntityT1, LinkedEntityT1>;
    /**
