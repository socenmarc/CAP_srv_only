...
var destination_service_types_1 = require("../../../scp-cf/destination/destination-service-types");
    ...
    MethodRequestBuilderBase.prototype.build = function (destination, options) {
        ...
        if (destination) {
            return scp_cf_1.useOrFetchDestination(destination, options)
                ...
                return Promise.reject(util_1.errorWithCause(noDestinationErrorMessage(destination), error));
            });
        }
