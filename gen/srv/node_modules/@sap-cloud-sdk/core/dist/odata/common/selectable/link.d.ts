 ...
 */
export declare class Link<EntityT extends EntityBase, LinkedEntityT extends EntityBase = any> implements EntityIdentifiable<EntityT> {
     ...
     */
    static clone<EntityT1 extends EntityBase, LinkedEntityT1 extends EntityBase>(link: Link<EntityT1, LinkedEntityT1>): Link<EntityT1, LinkedEntityT1>;
