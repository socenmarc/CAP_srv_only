...
var filter_functions_1 = require("../common/filter/filter-functions");
/* String Functions */
/**
...
function substringOf(substr, str) {
    return filter_function_1.filterFunction('substringof', 'boolean', substr, str);
}
...
function replace(str, searchStr, replaceStr) {
    return filter_function_1.filterFunction('replace', 'string', str, searchStr, replaceStr);
}
 ...
 */
exports.length = filter_functions_1.filterFunctions.length;
/**
 *  @hidden
 * Export substring filter function for backwards compatibility.
 */
exports.substring = filter_functions_1.filterFunctions.substring;
/**
 * OData v2 specific filter functions
 */
exports.filterFunctionsV2 = __assign(__assign({}, filter_functions_1.filterFunctions), { substringOf: substringOf,
    replace: replace });
